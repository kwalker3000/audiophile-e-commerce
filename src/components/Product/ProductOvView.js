      ...
      <div className="prod-ov-view">
        ...
        <div className="prod-ov-view__content content-wrapper">
          <div className="prod-ov-view__text-wrapper text-wrapper">
            {product.new ? (
              <p className="prod-ov-view__overline overline">new product</p>
            ) : (
              <></>
            )}
            <h2 className="prod-ov-view__head head_level-2">{product.name}</h2>
            <p className="prod-ov-view__body paragraph">
              {product.description}
            </p>
            <p className="prod-ov-view__price price">$ {product.price}</p>
          </div>
