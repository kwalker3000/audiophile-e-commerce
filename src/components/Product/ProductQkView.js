...
export const ProductQkView = ({ data }) => {
  ...
  return data.map((product) => (
    <div id="prod-qk-view" key={product._id}>
      <div className="prod-qk-view">
        ...
        <div className="prod-qk-view__content content-wrapper">
          <div className="prod-qk-view__text text-wrapper">
            {product.new ? (
              <p className="prod-qk-view__overline overline">new product</p>
            ) : (
              <></>
            )}
            <h2 className="prod-qk-view__head head_level-2">{product.name}</h2>
