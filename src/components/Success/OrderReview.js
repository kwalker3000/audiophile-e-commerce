  ...
  return (
    <div id="order-review">
      <div className="order-review">
        ...
        <div>
          <h2 className="order-review__head head_level-2">
        ...
        <div className="order-review__summary summary-wrapper">
          <div className="order-review__items items-wrapper">
            ...
            {cart.length > 1 && (
              <div className="order-review__extra extra-wrapper">
                <p
                  className="paragraph"
          ...
          <div className="order-review__total total-wrapper">
            ...
            <h6 className="total__head_6 head_level-6">
